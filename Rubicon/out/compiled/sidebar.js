var app = (function () {
    ...
    // (25:2) {#each todos as todo (todo.text)}
    function create_each_block(key_1, ctx) {
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[4](/*todo*/ ctx[6], /*each_value*/ ctx[7], /*todo_index*/ ctx[8]);
    	}
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(li, "class", "svelte-1w57xtn");
    			toggle_class(li, "complete", /*todo*/ ctx[6].completed);
    			add_location(li, file, 25, 4, 502);
    			this.first = li;
    		},
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*todos*/ 1 && t0_value !== (t0_value = /*todo*/ ctx[6].text + "")) set_data_dev(t0, t0_value);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(25:2) {#each todos as todo (todo.text)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 6, 0, 109);
    			add_location(p, file, 13, 0, 264);
    			add_location(input, file, 20, 2, 415);
    			add_location(form, file, 14, 0, 291);
    			add_location(ul, file, 23, 0, 455);
    			add_location(button, file, 36, 0, 681);
    		},
